...
fun findCheapestStuff(stuff: Map<String, Pair<String, Double>>, kind: String): String? {
    val temp = mutableMapOf<String, Pair<String, Double>>()
...
fun canBuildFrom(chars: List<Char>, word: String): Boolean =
    chars.joinToString(separator = "").toLowerCase().toList().containsAll(word.toLowerCase().toList())

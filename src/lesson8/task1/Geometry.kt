...
fun circleByDiameter(diameter: Segment): Circle {
    ...
    val r = sqrt((diameter.end.x - diameter.begin.x).pow(2) + (diameter.end.y - diameter.begin.y).pow(2)) / 2
...
fun lineBySegment(s: Segment): Line {
    var ang = if (s.end.x - s.begin.x == 0.0)
        PI / 2
    else
